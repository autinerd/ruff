...
try:
    ...
except (ValueError, *(RuntimeError, TypeError)) + (EOFError, ArithmeticError) + (Exception, *[BlockingIOError, *(BrokenPipeError,)]):
    ...
...
try:
    ...
except ((EOFError,) + (ValueError,(ArithmeticError,))):  # error
    ...
